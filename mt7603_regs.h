...
#define MT_AGG_PCR			MT_WF_AGG(0x054)
...
#define MT_WF_ARB_BCNQ_OPMODE_MASK	GENMASK(1, 0)
#define MT_WF_ARB_BCNQ_OPMODE_SHIFT(n)	(n * 2)
#define MT_WF_ARB_TX_DISABLE		BIT(8)
#define MT_WF_ARB_RX_DISABLE		BIT(9)
#define MT_WF_ARB_BCNQ_EMPTY_SKIP	BIT(28)
#define MT_WF_ARB_TTTT_BTIM_PRIO	BIT(29)
#define MT_WF_ARB_TBTT_BCN_PRIO		BIT(30)
#define MT_WF_ARB_TBTT_BCAST_PRIO	BIT(31)
